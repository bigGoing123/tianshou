...
train_envs = ts.env.DummyVectorEnv([lambda: simple_tag_v3.env(render_mode="human") for _ in range(train_num)])
test_envs = ts.env.DummyVectorEnv([lambda: simple_tag_v3.env(render_mode="human") for _ in range(test_num)])
